...
namespace GreetingService.WebHost
{
    ...
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://soa.ctrip.com/framework/soa/greetingservice/v1")]
    [System.Xml.Serialization.XmlRootAttribute("GreetingRequest", Namespace="http://soa.ctrip.com/framework/soa/greetingservice/v1", IsNullable=false)]
    [DataContract(Name="GreetingRequest", Namespace="http://soa.ctrip.com/framework/soa/greetingservice/v1")]
    [ProtoContract()]
    public partial class GreetingRequestType : ISpecificRecord
    {
        
        private string nameField;
        
        public static readonly CServiceStack.Baiji.Schema.Schema SCHEMA = CServiceStack.Baiji.Schema.Schema.Parse((("{\"type\":\"record\",\"name\":\"GreetingRequestType\",\"namespace\":\"" + typeof(GreetingRequestType).Namespace) 
    ...
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    [System.Xml.Serialization.XmlTypeAttribute(Namespace="http://soa.ctrip.com/framework/soa/greetingservice/v1")]
    [System.Xml.Serialization.XmlRootAttribute("GreetingResponse", Namespace="http://soa.ctrip.com/framework/soa/greetingservice/v1", IsNullable=false)]
    [DataContract(Name="GreetingResponse", Namespace="http://soa.ctrip.com/framework/soa/greetingservice/v1")]
    [ProtoContract()]
    public partial class GreetingResponseType : ISpecificRecord, IHasResponseStatus
    {
        
        private string greetingResultField;
        
        private ResponseStatusType responseStatusField;
        
        public static readonly CServiceStack.Baiji.Schema.Schema SCHEMA = CServiceStack.Baiji.Schema.Schema.Parse(((("{\"type\":\"record\",\"name\":\"GreetingResponseType\",\"namespace\":\"" + typeof(GreetingResponseType).Namespace) 
                        + (("\",\"doc\":null,\"fields\":[{\"name\":\"GreetingResult\",\"type\":[\"string\",\"null\"]},{\"name\"" +
                            ":\"ResponseStatus\",\"type\":{\"type\":\"record\",\"name\":\"ResponseStatusType\",\"namespace" +
        ...
        public string GreetingResult
        {
            get
            {
                return this.greetingResultField;
            }
            set
            {
                this.greetingResultField = value;
            }
        }
        ...
        public virtual object Get(int fieldPos)
        {
            switch(fieldPos)
            {
                case 0: return this.GreetingResult;
        ...
        public virtual void Put(int fieldPos, object fieldValue)
        {
            switch(fieldPos)
            {
                case 0: this.GreetingResult = (System.String)fieldValue; break;
    ...
    /// 
    /// </summary>
    [CServiceInterface("GreetingService", "http://soa.ctrip.com/framework/soa/greetingservice/v1", "2.0.9.0")]
    public interface IGreetingService
    {
        
        CheckHealthResponseType CheckHealth(CheckHealthRequestType request);
        
        Task<GreetingResponseType> Greeting(GreetingRequestType request);
    }
}
